...
Future updateLocalizationFile() async {
  ...
  https: //docs.google.com/spreadsheets/d/14_1gp_8OK2eunzbNlmVku8YO7X7VvoxDr0_d6EhITT8/edit?usp=sharing
  // String documentId = "1oS7iJ6ocrZBA53SxRfKF0CG9HAaXeKtzvsTBhgG4Zzk";
  String documentId = "14_1gp_8OK2eunzbNlmVku8YO7X7VvoxDr0_d6EhITT8";
        ...
        if (key == 'key') {
          ...
          if (_languageAdded == false) {
            _localizations.add(LocalizationModel(
                language: key, phrases: [PhraseModel(key: _phraseKey, phrase: value)]));
          }
        }
      });
    }
...
class LocalizationModel {
  ...
  factory LocalizationModel.fromMap(Map data) {
    return LocalizationModel(
      ...
      phrases: (data['phrases'] as List).map((v) => PhraseModel.fromMap(v)).toList(),
    );
  }
